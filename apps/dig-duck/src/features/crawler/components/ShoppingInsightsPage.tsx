...
import { TrendingUp, Search, BarChart3, Calendar, Smartphone, Users, Filter, Info } from "lucide-react";
...
const ShoppingInsightsPage: React.FC = () => {
  ...
  const categoryOptions = [
    { value: "50000000", label: "패션의류", description: "의류, 신발, 가방 등" },
    { value: "50000001", label: "패션잡화", description: "액세서리, 시계, 지갑 등" },
    { value: "50000002", label: "화장품/미용", description: "스킨케어, 메이크업 등" },
    { value: "50000003", label: "디지털/가전", description: "스마트폰, 컴퓨터 등" },
    { value: "50000004", label: "가구/인테리어", description: "가구, 홈데코 등" },
    { value: "50000005", label: "출산/육아", description: "유아용품, 장난감 등" },
    { value: "50000006", label: "식품", description: "건강식품, 간식 등" },
    { value: "50000007", label: "스포츠/레저", description: "운동용품, 아웃도어 등" },
    { value: "50000008", label: "생활/건강", description: "생활용품, 건강관리 등" },
    { value: "50000009", label: "여가/문화", description: "도서, 음반, 게임 등" }
  ];
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-2">
                  ...
                  <Label className="text-base font-semibold text-gray-900">조회 기간</Label>
                </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-2">
                  ...
                  <Label className="text-base font-semibold text-gray-900">카테고리 선택</Label>
                </div>
                <div className="space-y-2">
                  ...
                  <div className="flex items-start space-x-1 text-xs text-gray-500">
                    ...
                    <span>네이버 쇼핑에서 제공하는 주요 카테고리 기준으로 데이터를 분석합니다.</span>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-4 pt-4 border-t border-gray-200">
                <div className="flex items-center space-x-2">
                  ...
                  <Label className="text-base font-semibold text-gray-900">분석 조건</Label>
                </div>
                ...
                <div className="bg-blue-50 rounded-lg p-4">
                  <div className="space-y-4">
                    ...
                    <div className="space-y-3">
                      <Label className="text-sm font-medium text-gray-700">데이터 구간 단위</Label>
                      <RadioGroup
                        value={timeUnit}
                        onValueChange={(value) => setTimeUnit(value as TimeUnit)}
                        className="grid grid-cols-1 sm:grid-cols-3 gap-3"
                      >
                        <div className={`relative cursor-pointer ${timeUnit === 'date' ? 'ring-2 ring-blue-500' : ''}`}>
                          <input
                            type="radio"
                            id="date"
                            value="date"
                          ...
                          >
                            <div className="flex items-center justify-between">
                              <div>
                                <div className="font-semibold text-base">일간 분석</div>
                                <div className="text-sm text-gray-600 mt-1">세밀한 트렌드 분석</div>
                              </div>
                        ...
                        <div className={`relative cursor-pointer ${timeUnit === 'week' ? 'ring-2 ring-blue-500' : ''}`}>
                          <input
                            type="radio"
                            id="week"
                            value="week"
                          ...
                          >
                            <div className="flex items-center justify-between">
                              <div>
                                <div className="font-semibold text-base">주간 분석</div>
                                <div className="text-sm text-gray-600 mt-1">중간 단위 트렌드</div>
                              </div>
                              <div className={`w-5 h-5 rounded-full border-2 ${
                                timeUnit === 'week' 
                                  ? 'border-blue-500 bg-blue-500' 
                        ...
                        <div className={`relative cursor-pointer ${timeUnit === 'month' ? 'ring-2 ring-blue-500' : ''}`}>
                          <input
                            type="radio"
                            id="month"
                            value="month"
                          ...
                          >
                            <div className="flex items-center justify-between">
                              <div>
                                <div className="font-semibold text-base">월간 분석</div>
                                <div className="text-sm text-gray-600 mt-1">장기 트렌드 분석</div>
                              </div>
                              <div className={`w-5 h-5 rounded-full border-2 ${
                                timeUnit === 'month' 
                                  ? 'border-blue-500 bg-blue-500' 
                ...
                {/* 필터링 조건 */}
                <div className="space-y-4">
                  <Label className="text-sm font-medium text-gray-700">필터링 조건 (선택사항)</Label>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center space-x-2">
                        ...
                        <Label className="text-sm font-medium text-gray-700">접속 기기</Label>
                      </div>
                      <div className="space-y-2">
                        <div className={`relative cursor-pointer ${device === 'all' ? 'ring-2 ring-blue-500' : ''}`}>
                          <input
                            type="radio"
                            id="device-all"
                            value="all"
                        ...
                        <div className={`relative cursor-pointer ${device === 'pc' ? 'ring-2 ring-blue-500' : ''}`}>
                          <input
                            type="radio"
                            id="device-pc"
                            value="pc"
                        ...
                        <div className={`relative cursor-pointer ${device === 'mo' ? 'ring-2 ring-blue-500' : ''}`}>
                          <input
                            type="radio"
                            id="device-mo"
                            value="mo"
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="space-y-2">
                        <div className={`relative cursor-pointer ${gender === 'all' ? 'ring-2 ring-blue-500' : ''}`}>
                          <input
                            type="radio"
                            id="gender-all"
                            value="all"
                        ...
                        <div className={`relative cursor-pointer ${gender === 'm' ? 'ring-2 ring-blue-500' : ''}`}>
                          <input
                            type="radio"
                            id="gender-m"
                            value="m"
                        ...
                        <div className={`relative cursor-pointer ${gender === 'f' ? 'ring-2 ring-blue-500' : ''}`}>
                          <input
                            type="radio"
                            id="gender-f"
                            value="f"
                  ...
                  {/* 연령대 선택 */}
                  <div className="space-y-3">
                    <Label className="text-sm font-medium text-gray-700">연령대 (다중선택 가능)</Label>
                      ...
                      {ageGroups.map(({ value, label }) => (
                        <div key={value} className="flex items-center space-x-2">
                          <Checkbox
                            ...
                            onCheckedChange={(checked) => handleAgeChange(value, checked as boolean)}
                            className="w-4 h-4"
                          />
                          <Label htmlFor={`age-${value}`} className="text-sm cursor-pointer font-medium">
                            {label}
                          </Label>
                        </div>
                      ))}
                    ...
                    {selectedAges.length > 0 && (
                      <div className="text-xs text-blue-600 bg-blue-50 rounded px-2 py-1">
                        선택된 연령대: {selectedAges.map(age => ageGroups.find(g => g.value === age)?.label).join(', ')}
                      </div>
                    )}
                  </div>
                </div>
                  ...
                  <div className="text-sm text-gray-600">
                    {!startDate || !endDate || !category ? (
                      <div className="flex items-center space-x-1 text-red-600">
                        ...
                        <span>필수 항목을 모두 입력해주세요 (기간, 카테고리)</span>
                      </div>
                    ) : (
