      ...
      <div className="flex flex-wrap gap-2">
        {options.map((option) => (
          ...
          >
            ...
            />
            <div
              className={`${baseClass} rounded-full border-2 text-center transition-all duration-200 whitespace-nowrap ${
                value === option.value
      ...
      <div className="flex space-x-1 bg-gray-100 p-1 rounded-lg">
        {options.map((option) => (
          <label key={option.value} className="flex-1 cursor-pointer">
            ...
            />
            <div
              className={`${baseClass} rounded-md text-center transition-all duration-200 ${
                value === option.value
    ...
    <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
      {options.map((option) => (
        ...
        >
          ...
          />
          <div
            className={`${baseClass} rounded-xl border-2 text-center transition-all duration-200 ${
              value === option.value
